<template>
    <header class="">
        <!-- TODO: Set Bg color to dark green & text to white -->
        <div class="flex justify-between flex-col md:flex-row w-full bg-teal shadow-lg max-w-full">
            <nav class="flex w-full justify-between items-stretch">
                <Logo />
                ...
                <div class="flex justify-end items-center text-base w-1/5">
                    ...
                    <router-link :to="{name: 'user'}" class="mr-2 hover:text-green">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                            <path fill-rule="evenodd"
                    ...
                    <router-link :to="{name: 'chat'}" class="mr-2  hover:text-green">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                            <path
